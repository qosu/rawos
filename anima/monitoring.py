"""
anima Prometheus metrics — Phase 5.
...
agent_spawns_total = Counter(
    "anima_agent_spawns_total",
    "Sub-agents spawned by orchestrator",
    ["agent_type"],
)

rate_limit_hits_total = Counter(
    "anima_rate_limit_hits_total",

...
from anima.kernel.arch.base import FileOperator, FileSnapshot, ServiceManager

log = logging.getLogger("anima.kernel.operator")
...
def operate_on_file(
    ...
    *,
    ...
    from anima.kernel.arch import get_arch  # local import avoids circular at module load
...
def operate_on_unit_topology(
    ...
    *,
    ...
    from anima.kernel import unit_topology as _ut
    from anima.config import settings
    ...
    if mgr is not None:
        ...
        from anima.kernel.arch.linux import LinuxUnitTopologyManager

"""rawos/context/system_perception.py — Phase 20: Being's real-time filesystem senses.
...
from rawos.context.collector import _IGNORE_FILE_PREFIXES, _IGNORE_PREFIXES, _record_event

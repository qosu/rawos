...
from rawos.dataset.schema import DatasetExample, VALID_DOMAINS

log = logging.getLogger("rawos.dataset.manager")
...
async def build(
    *,
    ...
    if extract:
        from rawos.dataset.extractor import extract_from_tg_claude
    ...
    if synthetic_per_domain > 0:
        from rawos.dataset.synthetic import generate_synthetic
